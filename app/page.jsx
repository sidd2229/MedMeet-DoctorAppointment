          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-[400px] lg:h-[500px] rounded-xl overflow-hidden">
              <Image
                ...
                fill
                priority
                // className="object-contain md:pt-18 rounded-xl"
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Card
                key={index}
               className="bg-card border-2 border-emerald-900/30 transition-all duration-200 transform hover:scale-[1.05] hover:-translate-y-2 hover:shadow-xl hover:border-emerald-400"
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <Card
                key={index}
                className="bg-card border-1 border-emerald-900/30 transition-all duration-300 transform hover:scale-[1.05] hover:-translate-y-2 hover:shadow-xl hover:border-emerald-400"
              >
